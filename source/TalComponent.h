...
class TalComponent   : public AudioProcessorEditor,
                          ...
                          public Slider::Listener, //Burl26 April 2019
						  public Button::Listener, //Burl26 April 2019
						  public ComboBox::Listener //Burl26 April 2019
{
public:
    ...
    */
    ...
    static const char* bmp00128_png;	// the main GUI graphic
    ...
    static const char* prev_png;
    static const int prev_pngSize;
    static const char* next_png;
    static const int next_pngSize;
...
private:
	...
	Label *versionLabel;
    Label *infoText;
    //Burl26 April 2019 new controls
	Label *progNum;
    TalComboBox *progChooser;
	TextButton *progNextButton;
	TextButton *progPrevButton;
	TextButton *progInitButton;
	TextButton *progRenameButton;
	ImageToggleButton *midiGlobalLearnButton;  //Burl26 Return of MIDI Learn!
...
//    ImageToggleButton *saveButton;
	...
	TextButton* addTextButton(Component *component, int x, int y, int w, int h, juce::String s);
